...
import { createAlarmForm } from "./forms";

export class AlarmModal extends Modal {
  public constructor(app: App, private readonly items: ItemService, private readonly i18n: I18n) { super(app); }
  public override onOpen(): void {
    this.setTitle(this.i18n.messages.commandSetAlarm);
    const form = createAlarmForm(this.contentEl, this.items, "online-alarm-timer-modal-alarm", () => this.close(), this.i18n);
